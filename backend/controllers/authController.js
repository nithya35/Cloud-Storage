...
exports.resetPassword = catchAsync(async(req,res,next)=>{
    //we know token sent to user is non encrypted but the one stored in database is encrypted
    ...
    const isSame = await user.correctPassword(req.body.password, user.password);
    if (isSame) {
