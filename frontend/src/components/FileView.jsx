...
const FileView = ({ setCurrentFolderId, refreshFlag, setRefreshFlag}) => {
  ...
  if (files.length === 0 && folders.length === 0) return <p className="no-files">No files or folders yet. Upload something!</p>;
